...
public sealed partial class MassStreamUnit : IFractionalUnit<MassUnit, TimeUnit>, IEquatable<MassStreamUnit>, IDecomposableUnit
{
    /// <summary>
    ...
    {
        // generator : FractionUnitGenerator
        return other is MassStreamUnit value && Equals(value);
    }
